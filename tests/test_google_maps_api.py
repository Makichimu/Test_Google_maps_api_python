...
class Test_create_place():
    ...
    def test_create_new_place(self):
        ...
        # Checking.check_json_value(result_get, 'msg', 'Get operation failed, looks like data doesn\'t exists')
        Checking.check_json_search_word_in_value(result_get, 'msg', 'date')
        print("Тестирование создания, изменения и удаления локаций прошло успешно")